...
public:
	...
	Client()
		: controlConnectionIP{""},
		  ...
		  dataDumpReceiverPortNumber{controlConnectionPortNumber +
									 FTP::OFFSET_dataConnectionToClient} {}

	// Paramterized constructor
	Client(string _controlConnectionIP, const int _controlConnectionPortNumber)
